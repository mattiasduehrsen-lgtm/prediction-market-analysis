...
PAUSE_FLAG = OUT_DIR / "paused.live.flag"   # dashboard writes this to pause live entries only (paper continues)
...
class LiveEngine5m:
    ...
    def place_entry(
        ...
        if PAUSE_FLAG.exists():
            print(f"[LIVE5M] PAUSED — not placing new entries (delete paused.live.flag to resume)")
            return None
